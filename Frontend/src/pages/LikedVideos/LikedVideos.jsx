  ...
  return (
    <div className="max-w-[1280px] mx-auto p-4 md:p-6 lg:px-8">
      <motion.h1 className="flex items-center gap-3 text-2xl md:text-[28px] font-light text-white/90 mb-6"
        ...
        <HiOutlineThumbUp className="text-teal-primary" /> Liked <span className="text-teal-gradient">Videos</span>
      </motion.h1>
      {loading ? (
        ...
        <div className="flex flex-col items-center justify-center py-20 px-5 text-center">
          ...
          <h3 className="text-xl font-semibold mb-2 text-white/90">No liked videos</h3>
          <p className="text-sm text-white/50">Videos you like will appear here</p>
        </div>
      )}
    </div>
  );
